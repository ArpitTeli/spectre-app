...
SURFACE_COSTS = {
    ...
    "mbt":       [1.0, 1.0,  1.8,    0.70,    99.0, 1.1,  35.0],
    "ifv":       [1.0, 1.0,  1.5,    0.75,    99.0, 1.0,  30.0],
    "apc":       [1.0, 1.0,  1.3,    0.65,     1.8, 1.0,  30.0],
    "mrap":      [1.0, 1.0,  1.4,    0.60,    99.0, 1.0,  35.0],
    "light":     [1.0, 1.0,  1.2,    0.60,    99.0, 1.0,  25.0],
    "truck":     [1.0, 1.0,  1.6,    0.55,    99.0, 1.1,  40.0],
    "spg":       [1.0, 1.0,  1.8,    0.70,    99.0, 1.1,  35.0],
    "spaa":      [1.0, 1.0,  1.5,    0.75,    99.0, 1.0,  30.0],
    "eng":       [1.0, 1.0,  1.3,    0.80,    99.0, 1.0,  25.0],
    "infantry":  [1.0, 1.0,  1.0,    1.0,     10.0, 1.0,   3.0],
